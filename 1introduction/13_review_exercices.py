...
# chapter 13 review ex 1 : Write a script that grabs the full HTML from the page dionysus.html
print('-'*10, "Review exercice 1 chapter 13", '-'*10)
...
# chapter 13 review ex 2 : 
print('-'*10, "Review exercice 2 chapter 13", '-'*10)
...
# chapter 13 review ex 3 : 
print('-'*10, "Review exercice 3 chapter 13", '-'*10)
# from correction 
for tag in ["Name:.*?[\n<]", "Favorite Color:.*?[\n<]"]:
